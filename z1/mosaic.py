...
i = 0
images = np.zeros(
    [4, 240, 240, 4], dtype=np.uint8
)  # Obrazky sa budu ukladat tu, nie do suboru
...
images[0, :, :, :] = cv2.filter2D(images[0, :, :, :], -1, kernel)
